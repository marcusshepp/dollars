...
function build_items(items, names, where_froms, prices, times_purchased, ids, page_number, total_pages, per_page, cata_names_set, cata_ids_set, total_number_of_items){
     if (items){
         ...
         for (var i = 0; i < names.length; i++){
           ...
           item_markup += "</div>";
           item_markup += '<input type="button" class="btn more_info_btn" onclick="show_item_info('+id+')" value="More Info">';
           item_markup += '<input type="button" class="btn options_btn" onclick="show_options(this, '+id+')" value="Options" />';
           item_markup += '</div>';
           item_markup += '</form>';
           item_markup += "</div>";
           }
